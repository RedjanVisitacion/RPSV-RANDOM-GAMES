...
},{"./utils/Vec.js":25}],10:[function(require,module,exports){
"use strict";
...
var TiledLevel = function (_TileMap) {
  ...
  function TiledLevel(data, parsed) {
    ...
    var _this = _possibleConstructorReturn(this, (TiledLevel.__proto__ || Object.getPrototypeOf(TiledLevel)).call(this, tiles, mapW, mapH, tileH, tileW, texture));
...
},{"./Trigger.js":40}],35:[function(require,module,exports){
"use strict";
...
},{"../../pop/index.js":19}],37:[function(require,module,exports){
"use strict";
...
var WALL_JUMP_FORGIVENESS = 0.4;
var JUMP_FORGIVENESS = 0.08;
var JUMP_WALL_IMPULSE = 500;

var Player = function (_TileSprite) {
  _inherits(Player, _TileSprite);

  function Player(controls, map, hp) {
  ...
  _createClass(Player, [{
    ...
    key: "knockBack",
    value: function knockBack(e) {
      var vel = this.vel,
          acc = this.acc;

      var angle = entity.angle(this, e);
      var power = 400;

      vel.set(0, 0);
      acc.set(0, 0);

      var dir = new Vec(Math.cos(angle), -1).multiply(power);
    ...
    value: function update(dt, t) {
      ...
      var canWallJump = wallTimer > 0 && this.releasedAction;
...
},{"../../pop/index.js":19}],38:[function(require,module,exports){
"use strict";
...
var Spikes = function (_TileSprite) {
  _inherits(Spikes, _TileSprite);

  function Spikes() {
    var idle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1.0;
    var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1.5;
    var offset = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

    _classCallCheck(this, Spikes);

    var _this = _possibleConstructorReturn(this, (Spikes.__proto__ || Object.getPrototypeOf(Spikes)).call(this, texture, 48, 48));
...
},{"../../pop/index.js":19}],39:[function(require,module,exports){
"use strict";
...
},{"../../pop/index.js":19,"./Bullet.js":33}],40:[function(require,module,exports){
"use strict";
...
var Rect = _index2.default.Rect,
    Vec = _index2.default.Vec;

var Trigger = function () {
  function Trigger(hitBox, onCollide) {
    ...
    var w = hitBox.w,
        h = hitBox.h,
        _hitBox$x = hitBox.x,
        x = _hitBox$x === undefined ? 0 : _hitBox$x,
        _hitBox$y = hitBox.y,
        y = _hitBox$y === undefined ? 0 : _hitBox$y;
    ...
    this.h = h;
    if (x || y) {
      this.hitBox = { w: w, h: h, x: x, y: y };
    }

    this.onCollide = onCollide;
    if (debug) {
      var box = new Rect(w, h, { fill: "rgba(255, 255, 0, 0.5)" });
      box.pos.set(x, y);
      this.children = [box];
    }
  }
...
},{"../../pop/index.js":19}],41:[function(require,module,exports){
"use strict";
...
function title() {
  state = defaults();
  game.setScene(new _TitleScreen2.default(game, controls, function () {
    return startGame(1);
  }), 0);
}
function startGame(toLevel, spawn) {
  ...
  game.setScene(new _GameScreen2.default(game, controls, state, {
    onLevel: startGame,
    onReset: title
  }));
}
...
},{"../pop/index.js":19,"./screens/GameScreen.js":42,"./screens/TitleScreen.js":43}],42:[function(require,module,exports){
"use strict";
...
var _TiledLevel = require("../TiledLevel.js");

var _TiledLevel2 = _interopRequireDefault(_TiledLevel);
...
var _Door = require("../entities/Door.js");
...
var _Spikes = require("../entities/Spikes.js");

var _Spikes2 = _interopRequireDefault(_Spikes);
...
var Assets = _index2.default.Assets,
    Camera = _index2.default.Camera,
    Container = _index2.default.Container,
    entity = _index2.default.entity,
    OneUp = _index2.default.OneUp,
    State = _index2.default.State,
    Text = _index2.default.Text,
    Texture = _index2.default.Texture,
    TileSprite = _index2.default.TileSprite,
    Timer = _index2.default.Timer,
    ParticleEmitter = _index2.default.ParticleEmitter;
...
var GameScreen = function (_Container) {
  ...
  function GameScreen(game, controls, gameState, screens) {
    ...
    _this.state = new State("LOADING");
    _this.score = 0;

    _this.camera = _this.add(new Camera(null, { w: game.w, h: game.h }));
    _this.hud = _this.add(new Container());
    ...
    var levelUrl = "res/levels/bd_level0" + gameState.level + ".json?c=" + Date.now();
    var serialized = gameState.data[gameState.level];
    var level = serialized ? Promise.resolve(serialized) : Assets.json(levelUrl);

    level.then(function (json) {
      return _this.setupLevel(json, !!serialized);
    }).then(function () {
      // Level is loaded
      _this.loaded = true;
      if (gameState.spawn) {
        _this.player.pos.copy(_this.map.mapToPixelPos(gameState.spawn));
      }
    });
    return _this;
  }
  ...
  _createClass(GameScreen, [{
    ...
    key: "setupLevel",
    value: function setupLevel(json, parsed) {
      var _this2 = this;
      ...
      var map = new _TiledLevel2.default(json, parsed);
      var player = new _Player2.default(controls, map, gameState.hp);
      ...
      // Add level pickups
      map.spawns.pickups.forEach(function (p) {
        var pickup = _this2.pickups.add(new _Pickup2.default());
        pickup.pos.copy(p);
      });

      // Add level bad guys
      map.spawns.baddies.forEach(function (data) {
        var type = data.type,
            x = data.x,
            y = data.y,
            _data$properties = data.properties,
            properties = _data$properties === undefined ? {} : _data$properties;

        var b = _this2.baddies.add(_this2.makeBaddie(type));
        if (properties.speed) {
      ...
      // Add level doors
      map.spawns.doors.forEach(function (door) {
        var d = _this2.triggers.add(_this2.makeDoor(door));
        d.pos.copy(door);
      });

      var p = new TileSprite(texture, 48, 48);
      p.scale.x = 0.4;
      p.scale.y = 0.4;
      p.frame.x = 6;
      p.frame.y = 2;
    ...
    key: "makeBaddie",
    value: function makeBaddie(type) {
      var _this3 = this;
      ...
      switch (type) {
        case "Totem":
          e = new _Totem2.default(player, function (b) {
            _this3.addAfter.push(b);
            return b; //return baddies.add(b);
          });
          break;
        case "Ghost":
          e = new _Ghost2.default(map);
          break;
        case "Spikes":
          e = new _Spikes2.default();
          break;
        case "Bat":
          e = new _Bat2.default(player);
          break;
        default:
    ...
    value: function makeDoor(door) {
      ...
      var gameState = this.gameState,
          ...
          player = this.player;
      var _door$properties = door.properties,
          toLevel = _door$properties.toLevel,
          spawnX = _door$properties.spawnX,
          spawnY = _door$properties.spawnY;

      var t = new _Door2.default(door.properties, function () {
        gameState.doors[toLevel] = true;
        gameState.data[gameState.level] = map.serialize(_this4);
      ...
      // Set door tile
      var doorOpen = gameState.doors[toLevel];
      var tile = map.tileAtPixelPos(door);
    ...
    value: function gotPickup(pickup) {
      ...
      var coin = new TileSprite(texture, 48, 48);
      coin.anims.add("spin", [5, 6, 7, 8].map(function (x) {
        return { x: x, y: 4 };
      }), 0.1);
      coin.anims.play("spin");
      // OneUp it!
      var one = this.fx.add(new OneUp(coin));
    ...
    value: function openDoors() {
      ...
      map.spawns.doors.forEach(function (door) {
        var frame = _this5.map.tileAtPixelPos(door).frame;
    ...
    key: "playerWasHit",
    value: function playerWasHit(baddie) {
      ...
      if (player.hitBy(baddie)) {
        ...
        // Hit lag.
        this.add(new Timer(0.5, function (p) {
          return game.speed = (1 - p) * 2 + 1;
        }, function () {
          return game.speed = 1;
        }));
      }
    ...
    value: function update(dt, t) {
      ...
      if (this.addAfter.length) {
        this.addAfter.forEach(function (b) {
          return _this6.baddies.add(b);
        });
        this.addAfter = [];
      }
    ...
    value: function updatePlaying() {
      ...
      baddies.map(function (b) {
        ...
        if (entity.hit(player, b)) {
          _this7.playerWasHit(b);
        }
      });

      // Touched a door
      entity.hits(player, triggers, function (trigger) {
        return trigger.trigger();
      });

      // Collect pickup!
      entity.hits(player, pickups, function (pickup) {
        return _this7.gotPickup(pickup);
      });
    }
  }]);
...
},{"../../pop/index.js":19,"../TiledLevel.js":31,"../entities/Bat.js":32,"../entities/Door.js":34,"../entities/Ghost.js":35,"../entities/Pickup.js":36,"../entities/Player.js":37,"../entities/Spikes.js":38,"../entities/Totem.js":39}],43:[function(require,module,exports){
"use strict";
...
var TitleScreen = function (_Container) {
  ...
  function TitleScreen(game, controls, onStart) {
    ...
    _this.sprites = _this.add(new Container());

    _this.drawBackground(game.w, game.h);

    var elasticOut = math.ease.elasticOut;

    // Main title

    var title = new Sprite(textures.title);
    title.pos.set(200, -150);
    _this.title = _this.add(title);

    // Do title lerp, with easing
    _this.add(new Timer(1, function (p) {
    ...
    two.scale.y = 0.5;
    _this.add(new Timer(1, function (p) {
      return two.pos.y = game.h - elasticOut(p) * 330 - 190;
    }, null, 0.8));

    // Bravedigger
    var bd = new TileSprite(textures.wave, 48 * 5, 48 * 5);
    bd.pos.set(170, game.h / 2 - 100);
    _this.add(new Timer(2, function (p) {
      return bd.pos.y = elasticOut(p) * game.h - game.h / 1.6;
    }));
    _this.bd = _this.add(bd);
  ...
  _createClass(TitleScreen, [{
    ...
    value: function start() {
      ...
      this.starting = true;
      var yo = bd.pos.y;
      this.add(new Timer(0.6, function (p) {
    ...
    key: "drawBackground",
    value: function drawBackground(w, h) {
      var sprites = this.sprites;
      // Background sprites

      var tw = 48;
      var tx = Math.floor(w / tw) + 4;
      var ty = Math.floor(h / tw) + 4;
      for (var y = 0; y < ty; y++) {
        for (var x = 0; x < tx; x++) {
          var s = sprites.add(new TileSprite(textures.tiles, 48, 48));
          var frame = [0, 2];
...
},{"../../pop/index.js":19,"../ui.js":44}],44:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var fontFamily = "'Luckiest Guy', san-serif";
